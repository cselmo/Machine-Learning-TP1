...
class MultinomialNaiveBayes():
    ...
    def get_probas(self, dataframe):
        ...
        for label in self.labels:
            ...
            proba = (subset.sum()+alpha)  / (len(subset)+alpha*(len(self.labels))) #Calculo las probabilidades con smoothing
            self.log_likelihoods[label] = np.log( proba ) # Calculo las log probabilidades condicionales
